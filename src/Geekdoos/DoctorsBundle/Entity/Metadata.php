 ...
 * @ORM\Entity(repositoryClass="Geekdoos\DoctorsBundle\Repository\MetadataRepository")
 */
class Metadata
{
    /**
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Geekdoos\DoctorsBundle\Entity\Test", inversedBy="metadata")
   ...
   /**
     ...
     * Set test
     *
     * @param \Geekdoos\DoctorsBundle\Entity\Test $test
     * @return Metadata
     */
    public function setTest(\Geekdoos\DoctorsBundle\Entity\Test $test)
    {
        $this->test = $test;
     ...
     * Get test
     *
     * @return \Geekdoos\DoctorsBundle\Entity\Test
     */
