 ...
 * @ORM\Entity(repositoryClass="Geekdoos\DoctorsBundle\Repository\PersonRepository")
 */
class Person
{
    /**
    ...
    /**
    * @ORM\OneToMany(targetEntity="Geekdoos\DoctorsBundle\Entity\Antecedent", mappedBy="person", cascade={"remove", "persist"})
    */
    protected $antecedents;

    /**
    * @ORM\OneToMany(targetEntity="Geekdoos\DoctorsBundle\Entity\Consultation", mappedBy="person", cascade={"remove", "persist"})
    */
   ...
   /**
     ...
     * Add antecedents
     *
     * @param \Geekdoos\DoctorsBundle\Entity\Antecedent $antecedents
     * @return Person
     */
    public function addAntecedent(\Geekdoos\DoctorsBundle\Entity\Antecedent $antecedents)
    {
     ...
     * @param \Geekdoos\DoctorsBundle\Entity\Antecedent $antecedents
     */
    public function removeAntecedent(\Geekdoos\DoctorsBundle\Entity\Antecedent $antecedents)
    {
     ...
     * Add consultations
     *
     * @param \Geekdoos\DoctorsBundle\Entity\Consultation $consultations
     * @return Person
     */
    public function addConsultation(\Geekdoos\DoctorsBundle\Entity\Consultation $consultations)
    {
     ...
     * @param \Geekdoos\DoctorsBundle\Entity\Consultation $consultations
     */
    public function removeConsultation(\Geekdoos\DoctorsBundle\Entity\Consultation $consultations)
    {
