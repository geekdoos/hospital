 ...
 *
 * @ORM\Table(name="meds")
 * @ORM\Entity(repositoryClass="Geekdoos\DoctorsBundle\Repository\MedsRepository")
 */
class Meds
{
    /**
   ...
   /**
    ...
    /**
    * @ORM\OneToMany(targetEntity="Geekdoos\DoctorsBundle\Entity\ConsultationMeds", mappedBy="meds", cascade={"remove", "persist"})
    */
