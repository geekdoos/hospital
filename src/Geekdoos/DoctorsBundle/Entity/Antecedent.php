 ...
 * @ORM\Entity(repositoryClass="Geekdoos\DoctorsBundle\Repository\AntecedentRepository")
 */
class Antecedent
{
    /**
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Geekdoos\DoctorsBundle\Entity\Person", inversedBy="antecedents")
