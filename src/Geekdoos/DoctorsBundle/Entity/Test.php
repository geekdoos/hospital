 ...
 *
 * @ORM\Table(name="test")
 * @ORM\Entity(repositoryClass="Geekdoos\DoctorsBundle\Repository\TestRepository")
 */
class Test
{
    /**
    ...
    /**
    * @ORM\ManyToOne(targetEntity="Geekdoos\DoctorsBundle\Entity\Consultation", inversedBy="tests")
